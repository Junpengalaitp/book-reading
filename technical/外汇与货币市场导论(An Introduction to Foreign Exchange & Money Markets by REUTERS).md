...
### 利率套购(IRS)
* 交易双方在合约的有效期内的固定日期，按相同数量的相关名义本金，互为对方支付利息的协定。

### 远期利率协定期权（上限和下限）
* 利率保证是可以被看作一系列远期利率协定期权的一种合约。
* 利率上限是双方约定如果相关浮动利率超过了约定的履行价格，卖方要向买方支付一笔款项的合约。
* 利率下限是双方约定如果相关浮动利率低于约定的履约价格，卖方要向买方支付一笔款项的合约。

### 利率套购期权
* 给予固定或浮动利率付款人在约定的日期或在此之前的时间里按照约定的利率、期限买进或卖出利率套购的权利，而不是义务。
# 第三篇 外汇工具

## 第八章 交易工具
### 即期交易
#### 美元对其他货币
* 外汇即期交易是双方以约定的汇率交换两种不同的货币，并在两个营业日后进行结算的外汇交易。
* 买进或卖出的货币的报价是对基准货币而言的。基准货币通常是美元。
* 外汇报价惯例
  * 确定基准货币
  * 客户以显示的报价左边的汇率买入对应货币(即卖出基准货币)，以显示的报价右边的汇率卖出对应货币(即买入基准货币)
* 做市：利用差值
  * 差值越大，价格的防御性越强，机动性空间就越大。做市商的差值可用来评估弥补不合意的头寸的可能成本。
#### 交叉汇率交易
* 不包括美元的货币之间的汇率
#### 纯远期外汇交易
* 以在今天约定的汇率并在约定的未来某一个日期进行交付的外汇交易协定
* 贴水还是升水
  * 无套利远期汇率
    * 两种货币用各自的利率算出FV，然后用FV计算出的汇率

### 外汇套购(SWAP)
* 在两个日期里都有全额本金交换，没有利息支付
* 常见的三种类型
  * 即期对远期
  * 远期对远期
  * 短期日
